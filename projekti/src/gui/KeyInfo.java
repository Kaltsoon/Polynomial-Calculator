...
public class KeyInfo implements KeyListener{
    ...
    private String stringFromArray(List<String> list){
        if(list.isEmpty()){
            ...
            jPanel.show();
            draw.setImage("C:\\Users\\Kalle\\Documents\\NetBeansProjects\\Projekti\\src\\poly\\gui\\icon2_1.png");
            draw.repaint();
        ...
        String result = "";
        jPanel.show();
        draw.setImage("C:\\Users\\Kalle\\Documents\\NetBeansProjects\\Projekti\\src\\poly\\gui\\icon1_1.png");
        draw.repaint();
